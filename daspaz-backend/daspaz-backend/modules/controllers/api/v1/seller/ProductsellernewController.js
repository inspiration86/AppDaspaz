...
module.exports = new class ProductsellernewController extends Controller {
    ...
    store(req, res) {
        req.checkBody('id_productcategory', '  آیدی دسته محصولات نمی تواند خالی بماند').notEmpty();
        ...
        this.escapeAndTrim(req, 'id_productcategory productname price deatilproduct countproduct description imageproducturl ');
        if (this.showValidationErrors(req, res))
            return;
