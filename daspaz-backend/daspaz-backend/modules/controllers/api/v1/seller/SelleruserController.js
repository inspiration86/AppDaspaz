...
module.exports = new class SelleruserController extends Controller {
    ...
    store(req, res) {
        ...
        this.escapeAndTrim(req, 'firstname lastname nationalcode mobile address phone  certificateurl nationalcardurl profileurl password city_name country_name province_name');
        if (this.showValidationErrors(req, res))
            return;
