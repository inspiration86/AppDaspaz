        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.containerBottom}>
                    <Button titleStyle={{fontFamily: 'IRANSansMobile(FaNum)'}} style={{ fontFamily: 'IRANSansMobile(FaNum)',}} title="ثبت و مرحله بعد" color='#00bfa5'  onPress={() => this.props.navigation.push('Details')}/>
